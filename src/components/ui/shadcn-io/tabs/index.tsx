...
import { 
  MotionHighlight,
MotionHighlightItem } from '../motion-highlight';
...
function TabsList({
  ...
  return (
    <MotionHighlight
      controlledItems
      className={cn('rounded-sm shadow-sm', activeClassName)}
      value={activeValue}
      transition={transition}
    >
      <div
        ...
        data-slot="tabs-list"
        className={cn(
          'inline-flex h-10 w-fit items-center justify-center rounded-lg p-[4px]',
          className,
        )}
        {...props}
      >
